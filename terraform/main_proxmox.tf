...
module "dkr_media_0" {
  ...
  ipv4_address                = local.dkr_media_0.ipv4_address
  ipv4_gateway                = local.dkr_media_0.ipv4_gateway
...
output "dkr_media_0_vm_id" {
  value = module.dkr_media_0.vm_id
}
output "dkr_media_0_vm_ip" {
  value = module.dkr_media_0.vm_ipv4_address
}
